...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match='/'>
    <rss version="2.0">
      <channel>
        <title>www.jobs-hr.de - RSS 2.0 Feed</title>
        <link>http://www.jobs-hr.de/</link>
        <description>RSS Feed der www.jobs-hr.de Job-Angebote.</description>
  ...
  <xsl:template match="doc">
    ...
    <item>
        ...
        <link>http://www.jobs-hr.de/Job.<xsl:value-of select="$id"/>.2019.0.html</link>
        <guid>http://www.jobs-hr.de/Job.<xsl:value-of select="$id"/>.2019.0.html</guid>
