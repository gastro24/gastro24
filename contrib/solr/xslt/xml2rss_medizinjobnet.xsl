...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match='/'>
    <rss version="2.0">
      <channel>
        <title>www.medizinjob.net - RSS 2.0 Feed</title>
        <link>http://www.medizinjob.net/</link>
        <description>RSS Feed der www.medizinjob.net Job-Angebote.</description>
  ...
  <xsl:template match="doc">
    ...
    <item>
        ...
        <link>http://www.medizinjob.net/Job.<xsl:value-of select="$id"/>.1974.0.html</link>
        <guid>http://www.medizinjob.net/Job.<xsl:value-of select="$id"/>.1974.0.html</guid>
