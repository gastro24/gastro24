...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match='/'>
    <rss version="2.0">
      <channel>
        <title>www.jurajob24.de - RSS 2.0 Feed</title>
        <link>http://www.jurajob24.de/</link>
        <description>RSS Feed der www.jurajob24.de Job-Angebote.</description>
  ...
  <xsl:template match="doc">
    ...
    <item>
        ...
        <link>http://www.jurajob24.de/Job.<xsl:value-of select="$id"/>.2004.0.html</link>
        <guid>http://www.jurajob24.de/Job.<xsl:value-of select="$id"/>.2004.0.html</guid>
