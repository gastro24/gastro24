...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match='/'>
    <rss version="2.0">
      <channel>
        <title>www.technische-berufe.net - RSS 2.0 Feed</title>
        <link>http://www.technische-berufe.net/</link>
        <description>RSS Feed der www.technische-berufe.net Job-Angebote.</description>
  ...
  <xsl:template match="doc">
    ...
    <item>
        ...
        <link>http://www.technische-berufe.net/Job.<xsl:value-of select="$id"/>.1944.0.html</link>
        <guid>http://www.technische-berufe.net/Job.<xsl:value-of select="$id"/>.1944.0.html</guid>
