...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match='/'>
    <rss version="2.0">
      <channel>
        <title>www.vertriebsjobs.de - RSS 2.0 Feed</title>
        <link>http://www.vertriebsjobs.de/</link>
        <description>RSS Feed der www.vertriebsjobs.net Job-Angebote.</description>
  ...
  <xsl:template match="doc">
    ...
    <item>
        ...
        <link>http://www.vertriebsjobs.de/Job.<xsl:value-of select="$id"/>.1929.0.html</link>
        <guid>http://www.vertriebsjobs.de/Job.<xsl:value-of select="$id"/>.1929.0.html</guid>
