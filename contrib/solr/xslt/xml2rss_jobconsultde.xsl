...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match='/'>
    <rss version="2.0">
      <channel>
        <title>www.jobconsult.de - RSS 2.0 Feed</title>
        <link>http://www.jobconsult.de/</link>
        <description>RSS Feed der www.jobconsult.net Job-Angebote.</description>
  ...
  <xsl:template match="doc">
    ...
    <item>
        ...
        <link>http://www.jobconsult.de/Job.<xsl:value-of select="$id"/>.2034.0.html</link>
        <guid>http://www.jobconsult.de/Job.<xsl:value-of select="$id"/>.2034.0.html</guid>
