...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match='/'>
    <rss version="2.0">
      <channel>
        <title>www.mediakarriere.de - RSS 2.0 Feed</title>
        <link>http://www.mediakarriere.de/</link>
        <description>RSS Feed der www.mediakarriere.de Job-Angebote.</description>
  ...
  <xsl:template match="doc">
    ...
    <item>
        ...
        <link>http://www.mediakarriere.de/Job.<xsl:value-of select="$id"/>.1989.0.html</link>
        <guid>http://www.mediakarriere.de/Job.<xsl:value-of select="$id"/>.1989.0.html</guid>
