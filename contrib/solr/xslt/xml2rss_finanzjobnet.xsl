...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match='/'>
    <rss version="2.0">
      <channel>
        <title>www.finanzjob.net - RSS 2.0 Feed</title>
        <link>http://www.finanzjob.net/</link>
        <description>RSS Feed der www.finanzjob.de Job-Angebote.</description>
  ...
  <xsl:template match="doc">
    ...
    <item>
        ...
        <link>http://www.finanzjob.net/Job.<xsl:value-of select="$id"/>.2079.0.html</link>
        <guid>http://www.finanzjob.net/Job.<xsl:value-of select="$id"/>.2079.0.html</guid>
