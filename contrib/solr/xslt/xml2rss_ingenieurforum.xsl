...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match='/'>
    <rss version="2.0">
      <channel>
        <title>www.ingenieurforum.de - RSS 2.0 Feed</title>
        <link>http://www.ingenieurforum.de/</link>
        <description>RSS Feed der www.ingenieurforum.de Job-Angebote.</description>
  ...
  <xsl:template match="doc">
    ...
    <item>
        ...
        <link>http://www.ingenieurforum.de/Job.<xsl:value-of select="$id"/>.2491.0.html</link>
        <guid>http://www.ingenieurforum.de/Job.<xsl:value-of select="$id"/>.2491.0.html</guid>
