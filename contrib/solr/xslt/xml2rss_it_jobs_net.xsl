...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match='/'>
    <rss version="2.0">
      <channel>
        <title>www.it-jobs.net - RSS 2.0 Feed</title>
        <link>http://www.it-jobs.net/</link>
        <description>RSS Feed der www.it-jobs.net Job-Angebote.</description>
  ...
  <xsl:template match="doc">
    ...
    <item>
        ...
        <link>http://www.it-jobs.net/Job.<xsl:value-of select="$id"/>.2049.0.html</link>
        <guid>http://www.it-jobs.net/Job.<xsl:value-of select="$id"/>.2049.0.html</guid>
