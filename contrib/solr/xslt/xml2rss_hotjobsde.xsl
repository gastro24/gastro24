...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match='/'>
    <rss version="2.0">
      <channel>
        <title>www.hot-jobs.de - RSS 2.0 Feed</title>
        <link>http://www.hot-jobs.de/</link>
        <description>RSS Feed der www.hotjobs.de Job-Angebote.</description>
  ...
  <xsl:template match="doc">
    ...
    <item>
        ...
        <link>http://www.hot-jobs.de/Job.<xsl:value-of select="$id"/>.2064.0.html</link>
        <guid>http://www.hot-jobs.de/Job.<xsl:value-of select="$id"/>.2064.0.html</guid>
