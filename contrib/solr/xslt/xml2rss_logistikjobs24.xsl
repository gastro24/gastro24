...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match='/'>
    <rss version="2.0">
      <channel>
        <title>www.logistikjobs24.de - RSS 2.0 Feed</title>
        <link>http://www.logistikjobs24.de/</link>
        <description>RSS Feed der www.logistikjobs24.de Job-Angebote. Ein Angebot von Jobsintown.de</description>
  ...
  <xsl:template match="doc">
    ...
    <item>
        ...
        <link>http://www.jobsintown.de/Job.<xsl:value-of select="$id"/>.1867.0.html</link>
        <guid>http://www.jobsintown.de/Job.<xsl:value-of select="$id"/>.1867.0.html</guid>
